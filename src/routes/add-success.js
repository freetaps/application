...
customElements.define('page-add-success', class extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
<ion-header>
  <ion-toolbar>
...
<ion-content class="ion-padding">
  <div class="ion-content-safe-area">
    <ion-icon aria-hidden="true" color="medium" name="water"></ion-icon>
  ...
  _onLanguageChange = () => {
    Translator.translatePage(this, 'add-success');
  }
});
